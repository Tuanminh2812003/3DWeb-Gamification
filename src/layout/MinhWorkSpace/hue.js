...
const PuzzleGame = lazy(() => import('../GamePuzzle/hue1.js'));
const PuzzleGame2 = lazy(() => import('../GamePuzzle/hue2.js'));
...
const modelsConfig = useMemo(
    ...
    const backgroundAudioRef = useRef(null);
        ...
        useEffect(() => {
            const audio = new Audio('/Farm/Music/hue.MP3');
            audio.loop = true;
            audio.volume = 1;
        ...
        <>
            <CameraProvider>
                <div className='main'>
                    ...
                    {showQuestionPopup && (
                            <QuestionPopup
                            question="Quần thể di tích Cố đô Huế được UNESCO công nhận là Di sản Văn hóa Thế giới vào năm nào?"
                            answers={["1987", "1993 ", "1999", "2003"]}
                            correctAnswer="1993 "
                        ...
                        {showQuestionPopup2 && (
                            <QuestionPopup
                            question="Di tích nào ở Huế là biểu tượng tôn giáo nổi bật, nằm bên dòng sông Hương?"
                            answers={["Chùa Một Cột", "Chùa Thiên Mụ", "Chùa Trấn Quốc", "Chùa Bái Đính"]}
                            correctAnswer="Chùa Thiên Mụ"
                            onClose={handleCloseQuestionPopup2}
                            />
                        )}
                        {showQuestionPopup3 && (
                            <QuestionPopup
                            question="Nhã nhạc cung đình Huế thường được biểu diễn vào dịp nào trong triều đình xưa?"
                            answers={["Lễ hội truyền thống của dân gian", "Các dịp cưới hỏi", "Các nghi lễ cung đình và tế lễ quan trọng", "Các buổi biểu diễn thường nhật"]}
                            correctAnswer="Các nghi lễ cung đình và tế lễ quan trọng"
                            onClose={handleCloseQuestionPopup3}
                            />
                        )}
                        {showQuestionPopup4 && (
                            <QuestionPopup
                            question="Lăng vua nào ở Huế nổi bật với kiến trúc kết hợp Á – Âu và được trang trí bằng sành, sứ tinh xảo?"
                            answers={["Lăng Minh Mạng", "Lăng Tự Đức", "Lăng Gia Long", "Lăng Khải Định"]}
                            correctAnswer="Lăng Khải Định"
                ...
                <div className="popup-overlay">
                    <div className="popup-content">
                        ...
                        <h1>Thời gian hoàn thành: {formattedTime}</h1>
                    </div>
                </div>
            )}
                    {/* 🔥 Popup chứa game */}
            ...
            {/* Respondsive */}
            <ResizeHandler updateItemsForScreenSize={updateItemsForScreenSize} level="Hue" />
            {/* Respondsive */}
        </>
    )
}

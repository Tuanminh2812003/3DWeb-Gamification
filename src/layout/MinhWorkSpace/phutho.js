...
const PuzzleGame = lazy(() => import('../GamePuzzle/phutho1.js'));
const PuzzleGame2 = lazy(() => import('../GamePuzzle/phutho2.js'));
...
const modelsConfig = useMemo(
    () => [
        ...
        {
            path: "/Farm/bonus img phutho.glb",
            position: [0, 0, 0],
            rotation: [0, 0, 0],
            scale: [1, 1, 1],
            clickable: false,
    ...
    // mảng items các bức tranh để làm tour
        ...
        const [nextPath, setNextPath] = useState("/hanoi"); // Path chuyển tiếp
    ...
    const backgroundAudioRef = useRef(null);
        ...
        useEffect(() => {
            const audio = new Audio('/Farm/Music/phutho.MP3');
            audio.loop = true;
            audio.volume = 1;
        ...
        <>
            <CameraProvider>
                <div className='main'>
                    ...
                    {showQuestionPopup && (
                            <QuestionPopup
                            question="Trong tín ngưỡng thờ cúng Hùng Vương, có một nhân vật huyền thoại được xem là người đã có công truyền dạy nghề nông cho người dân Văn Lang. Đó là vị thần nào?"
                            answers={["Sơn Tinh", "Thủy Tinh", "Lạc Long Quân", "Lang Liêu"]}
                        ...
                        {showQuestionPopup2 && (
                            <QuestionPopup
                            question="Ngọn núi thiêng ở Phú Thọ tương truyền là nơi các Vua Hùng thường lui tới để cầu cúng trời đất là ?"
                            answers={["Núi Sóc", "Núi Tam Đảo", "Núi Ba Vì", "Núi Nghĩa Lĩnh"]}
                            correctAnswer="Núi Nghĩa Lĩnh"
                            onClose={handleCloseQuestionPopup2}
                            />
                        )}
                        {showQuestionPopup3 && (
                            <QuestionPopup
                            question="Loại hình nghệ thuật trình diễn đặc sắc nào của Phú Thọ đã được UNESCO công nhận là Di sản văn hóa phi vật thể đại diện của nhân loại?"
                            answers={["Hát Xoan", "Chèo", "Tuồng", "Ca Trù"]}
                            correctAnswer="Hát Xoan"
                            onClose={handleCloseQuestionPopup3}
                            />
                        )}
                        {showQuestionPopup4 && (
                            <QuestionPopup
                            question="Phú Thọ là nơi khởi nguồn của một loại hình hát dân gian độc đáo nào sau đây, thường được biểu diễn vào các dịp lễ hội?"
                            answers={["Hát Xoan", "Hát ví giặm", "Hát chầu văn", "Hát then"]}
                            correctAnswer="Hát Xoan"
                ...
                <div className="popup-overlay">
                    <div className="popup-content">
                        <h2>Chúc mừng bạn!</h2>
                        <p>Bạn đã qua màn 1, chuyển đến màn tiếp theo!</p>
            ...
            {/* Respondsive */}
            <ResizeHandler updateItemsForScreenSize={updateItemsForScreenSize} level="PhuTho" />
            {/* Respondsive */}
        </>
    )
}
